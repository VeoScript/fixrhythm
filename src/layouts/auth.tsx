...
const Auth: React.FC<TypeProps> = ({ children }) => {
  return (
    <div className="preventcopy font-poppins flex flex-col items-center justify-start md:justify-center w-full h-screen bg-pantone-white dark:bg-pantone-black overflow-hidden">
      <div className="relative flex flex-col items-center justify-start md:justify-center w-full max-w-[2400px] h-full overflow-y-auto md:overflow-y-hidden py-10 md:py-0 text-pantone-darkblack dark:text-pantone-white bg-pantone-white dark:bg-pantone-darkblack">
