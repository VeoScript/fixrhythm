...
import DisplayPrivacyPolicy from '~/components/DisplayPrivacyPolicy'
...
const PrivacyPolicy: NextPage<TypeProps> = ({ artists, get_notification }) => {
  ...
  return (
    <React.Fragment>
      <Head>
        <title>Fixrhythm | Privacy Policy</title>
      </Head>
      <Layout
        host={host}
        artists={artists}
