...
const DefaultLoader: React.FC<TypeProps> = ({ width, height, color }) => {
  return (
    <svg width={ width } height={ height } viewBox="0 0 135 140" xmlns="http://www.w3.org/2000/svg" fill="currentColor" color={ color }>
