        ...
        {host.username === get_profile.username && (
          <form onSubmit={handleSubmit(uploadProfilePhoto)} className="absolute bottom-3 right-3">
            <label htmlFor="upload_coverphoto">
              <div title="Change Cover Photo" className="cursor-pointer p-2 rounded-full bg-pantone-gray dark:bg-pantone-white bg-opacity-80 dark:bg-opacity-80 transition ease-linear duration-200 transform hover:scale-95">
            ...
            <div className="flex w-full max-w-full">
              {imageUploaded && (
                <div className="fixed inset-0 z-50 flex items-center justify-center w-full">
                  ...
                  <div className="flex flex-col items-center w-full max-w-5xl z-20 overflow-hidden text-pantone-darkblack dark:text-pantone-white bg-pantone-white dark:bg-pantone-black bg-opacity-10 dark:bg-opacity-10 backdrop-blur-sm shadow-xl rounded-xl border-2 border-pantone-white border-opacity-10">
                    <div className="flex flex-row items-center justify-between w-full px-5 py-3 bg-pantone-white dark:bg-pantone-darkblack">
                      ...
                      <h3 className="font-normal dark:font-light text-sm">Change Cover Photo</h3>
                    </div>
                    <div className="flex flex-col w-full">
                      <div className="flex flex-col items-center w-full p-3 space-y-2">
                        <img
                          className="flex w-full h-full max-h-[18rem] object-cover bg-center bg-cover bg-no-repeat bg-pantone-white dark:bg-[#1D1F21]"
                          src={previewCoverPhoto}
                          alt=""
                        />
                        <p className="font-normal dark:font-light text-[11px] text-pantone-white">This will be the actual layout of your cover photo.</p>
                      </div>
