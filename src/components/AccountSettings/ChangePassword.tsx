      ...
      <form onSubmit={handleSubmit(onChangePassword)} className="flex flex-col w-full border-b border-pantone-white border-opacity-10">
        ...
        <div className="flex flex-col w-full px-5 py-3 space-y-2">
          ...
          <div className="flex flex-row items-center justify-end w-full pt-1">
           {!isSubmitting && (
              <button
              className="flex justify-center w-full p-5 text-pantone-white bg-pantone-darkblack rounded-lg transition ease-linear duration-200 hover:bg-pantone-white hover:bg-opacity-10"
                type="submit"
              >
           ...
           {isSubmitting && (
              <div className="flex justify-center w-full p-5 text-pantone-white bg-pantone-darkblack rounded-lg">
