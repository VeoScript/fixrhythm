    ...
    <React.Fragment>
      ...
      <React.Fragment>
        ...
        {(user === '' || !host || host.isLoggedIn === false) && (
          <div className="flex flex-row items-center justify-between w-full px-3 md:px-0 py-3 shadow-sm dark:shadow-xl border-b border-pantone-gray dark:border-pantone-white border-opacity-10 dark:border-opacity-10">
